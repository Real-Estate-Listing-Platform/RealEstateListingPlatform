...
namespace RealEstateListingPlatform.Controllers
{
    public class AdminController : Controller
    {
        ...
        public AdminController(IListingService listingService, IAdminDashboardService adminDashboardService, IAuditLogService auditLogService)
        {
        ...
        {
            var viewModel = await BuildAdminPortalViewModelAsync(1, 20);
            SetAdminViewData("dashboard", viewModel);
        ...
        {
            var viewModel = await BuildAdminPortalViewModelAsync(1, 20);
            SetAdminViewData("listings", viewModel);
            return View(viewModel);
        }
        ...
        public async Task<IActionResult> Logs(int page = 1, int pageSize = 20)
        {
            ...
            var viewModel = await BuildAdminPortalViewModelAsync(page, pageSize);
            SetAdminViewData("logs", viewModel);
        ...
        {
            var viewModel = await BuildAdminPortalViewModelAsync(1, 20);
            SetAdminViewData("users", viewModel);
            return View(viewModel);
        }
        ...
        public async Task<IActionResult> GetComparison(Guid id)
        {
            ...
            var viewModel = MapToComparisonViewModel(result.Data);
            return PartialView("_ListingComparison", viewModel);
        }
        ...
        private void SetAdminViewData(string section, AdminPortalViewModel viewModel)
        {
            ViewData["Section"] = section;
            ViewData["PendingCount"] = viewModel.PendingListings.Count;
        }
